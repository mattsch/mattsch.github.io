...
src_unpack() {
	...
	if use dbus; then
		epatch ${FILESDIR}/${PN}-3.0.2-extended_option_environment.patch
		epatch ${FILESDIR}/dhcp-3.0.2-dhclient-no_isc_blurb.patch
		epatch ${FILESDIR}/dhcp-3.0.2-dhclient_nodelay.patch
		epatch ${FILESDIR}/dhcp-3.0.2-dhclient_decline_backoff.patch
		epatch ${FILESDIR}/dhcp-3.0.2-dhclient_script_fast+arping-1.patch
		epatch ${FILESDIR}/dhcp-3.0.2-dhclient-script-dbus-dhcdbd.patch
		epatch ${FILESDIR}/dhcp-3.0.2-gentoo-ify.patch
	fi
